...
(0, vitest_1.describe)("runStats", () => {
    const queryResultSet = new query_result_set_builder_1.QueryResultSetBuilder({
        getQueryRunResultsRpcResult: (0, mock_data_1.getQueryResultsResponse)("QUERY_STATE_SUCCESS").result,
        getQueryRunRpcResult: (0, mock_data_1.getQueryRunResponse)("QUERY_STATE_SUCCESS").result,
        error: null,
    });
    ...
    (0, vitest_1.it)("runStats recordCount = 1", () => __awaiter(void 0, void 0, void 0, function* () {
        var _c;
        vitest_1.assert.equal((_c = queryResultSet.runStats) === null || _c === void 0 ? void 0 : _c.recordCount, 10000);
    }));
    (0, vitest_1.it)("runStats elpasedSeconds = 51", () => __awaiter(void 0, void 0, void 0, function* () {
        var _d;
        vitest_1.assert.equal((_d = queryResultSet.runStats) === null || _d === void 0 ? void 0 : _d.elapsedSeconds, 51);
    }));
    (0, vitest_1.it)("runStats queuedSeconds = 0", () => __awaiter(void 0, void 0, void 0, function* () {
        var _e;
        vitest_1.assert.equal((_e = queryResultSet.runStats) === null || _e === void 0 ? void 0 : _e.queuedSeconds, 0);
    }));
    (0, vitest_1.it)("runStats streamingSeconds = 45", () => __awaiter(void 0, void 0, void 0, function* () {
        var _f;
        vitest_1.assert.equal((_f = queryResultSet.runStats) === null || _f === void 0 ? void 0 : _f.streamingSeconds, 45);
    }));
    (0, vitest_1.it)("runStats queryExecSeconds = 5", () => __awaiter(void 0, void 0, void 0, function* () {
        var _g;
        vitest_1.assert.equal((_g = queryResultSet.runStats) === null || _g === void 0 ? void 0 : _g.queryExecSeconds, 5);
    }));
});
...
(0, vitest_1.describe)("status", () => {
    ...
    (0, vitest_1.it)("isPending: QUERY_STATE_READY", () => __awaiter(void 0, void 0, void 0, function* () {
        const queryResultSet = new query_result_set_builder_1.QueryResultSetBuilder({
            getQueryRunResultsRpcResult: (0, mock_data_1.getQueryResultsResponse)("QUERY_STATE_READY").result,
            getQueryRunRpcResult: (0, mock_data_1.getQueryRunResponse)("QUERY_STATE_READY").result,
            error: null,
        });
        vitest_1.assert.equal(queryResultSet === null || queryResultSet === void 0 ? void 0 : queryResultSet.status, types_1.QueryStatusPending);
    }));
    (0, vitest_1.it)("isPending: QUERY_STATE_RUNNING", () => __awaiter(void 0, void 0, void 0, function* () {
        const queryResultSet = new query_result_set_builder_1.QueryResultSetBuilder({
            getQueryRunResultsRpcResult: (0, mock_data_1.getQueryResultsResponse)("QUERY_STATE_RUNNING").result,
            getQueryRunRpcResult: (0, mock_data_1.getQueryRunResponse)("QUERY_STATE_RUNNING").result,
            error: null,
        });
        vitest_1.assert.equal(queryResultSet === null || queryResultSet === void 0 ? void 0 : queryResultSet.status, types_1.QueryStatusPending);
    }));
    (0, vitest_1.it)("isPending: QUERY_STATE_STREAMING_RESULTS", () => __awaiter(void 0, void 0, void 0, function* () {
        const queryResultSet = new query_result_set_builder_1.QueryResultSetBuilder({
            getQueryRunResultsRpcResult: (0, mock_data_1.getQueryResultsResponse)("QUERY_STATE_STREAMING_RESULTS").result,
            getQueryRunRpcResult: (0, mock_data_1.getQueryRunResponse)("QUERY_STATE_STREAMING_RESULTS").result,
            error: null,
        });
        vitest_1.assert.equal(queryResultSet === null || queryResultSet === void 0 ? void 0 : queryResultSet.status, types_1.QueryStatusPending);
    }));
    (0, vitest_1.it)("isError: QUERY_STATE_FAILED", () => __awaiter(void 0, void 0, void 0, function* () {
        const queryResultSet = new query_result_set_builder_1.QueryResultSetBuilder({
            getQueryRunResultsRpcResult: (0, mock_data_1.getQueryResultsResponse)("QUERY_STATE_FAILED").result,
            getQueryRunRpcResult: (0, mock_data_1.getQueryRunResponse)("QUERY_STATE_FAILED").result,
            error: null,
        });
        vitest_1.assert.equal(queryResultSet === null || queryResultSet === void 0 ? void 0 : queryResultSet.status, types_1.QueryStatusError);
    }));
    (0, vitest_1.it)("isError: QUERY_STATE_CANCELLED", () => __awaiter(void 0, void 0, void 0, function* () {
        const queryResultSet = new query_result_set_builder_1.QueryResultSetBuilder({
            getQueryRunResultsRpcResult: (0, mock_data_1.getQueryResultsResponse)("QUERY_STATE_CANCELED").result,
            getQueryRunRpcResult: (0, mock_data_1.getQueryRunResponse)("QUERY_STATE_CANCELED").result,
            error: null,
        });
        vitest_1.assert.equal(queryResultSet === null || queryResultSet === void 0 ? void 0 : queryResultSet.status, types_1.QueryStatusError);
    }));
...
(0, vitest_1.describe)("queryID", () => {
    ...
    (0, vitest_1.it)("queryId is test", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        vitest_1.assert.equal(queryResultSet === null || queryResultSet === void 0 ? void 0 : queryResultSet.queryId, "clg44olzq00cbn60tasvob5l2");
    }));
});
