...
exports.createQueryRunResponse = void 0;
function createQueryRunResponse(status = "QUERY_STATE_READY", error = null, resultNull = false) {
    let defaultResult = {
        queryRequest: {
...
exports.createQueryRunResponse = createQueryRunResponse;
//# sourceMappingURL=create-query-run.js.map