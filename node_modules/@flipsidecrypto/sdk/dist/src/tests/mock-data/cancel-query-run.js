...
exports.cancelQueryRunResponse = void 0;
function cancelQueryRunResponse(status = "QUERY_STATE_SUCCESS", error = null) {
    let base = {
        jsonrpc: "2.0",
        id: 1,
        error: null,
    ...
    if (error !== null) {
        base = Object.assign(Object.assign({}, base), { error: error });
    }
    base = Object.assign(Object.assign({}, base), { result: defaultResult });
    return base;
}
exports.cancelQueryRunResponse = cancelQueryRunResponse;
//# sourceMappingURL=cancel-query-run.js.map